...
_ELEMENT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='child', full_name='fast.Element.child', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='unit', full_name='fast.Element.unit', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='literal', full_name='fast.Element.literal', index=5,
