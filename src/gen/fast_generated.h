...
struct Bug FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyOffset(verifier, VT_ID) &&
           verifier.Verify(id()) &&
           VerifyOffset(verifier, VT_OPENDATE) &&
           verifier.Verify(opendate()) &&
           VerifyOffset(verifier, VT_FIXDATE) &&
           verifier.Verify(fixdate()) &&
           VerifyOffset(verifier, VT_BUGINFO) &&
           verifier.VerifyTable(buginfo()) &&
           VerifyOffset(verifier, VT_FIXED_FILE) &&
