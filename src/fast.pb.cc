...
void Element::SerializeWithCachedSizes(
  ...
  // int32 line = 7;
  if (this->line() != 0) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(7, this->line(), output);
  }

  // int32 column = 8;
  if (this->column() != 0) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(8, this->column(), output);
  }
...
::google::protobuf::uint8* Element::InternalSerializeWithCachedSizesToArray(
  ...
  // int32 line = 7;
  if (this->line() != 0) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt32ToArray(7, this->line(), target);
  }

  // int32 column = 8;
  if (this->column() != 0) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt32ToArray(8, this->column(), target);
  }
